...
var cdclient_1 = require("./cdclient");
var config_json_1 = require("./config.json");
var setup_1 = require("./setup");
var db = new sqlite3_1.Database(config_json_1.sqlite_path);
var cdclient = new cdclient_1.CDClient(db);
var client = new discord_js_1.Client({
    intents: []
});
var slashCommands = (0, setup_1.getSlashCommands)();
...
client.on("interactionCreate", function (interaction) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        options = ((_a = interaction.options) === null || _a === void 0 ? void 0 : _a.data) || [];
        console.log(options);
